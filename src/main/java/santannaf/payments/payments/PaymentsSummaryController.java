...
public class PaymentsSummaryController {
    ...
    public PaymentsSummaryController(RedisTemplate<String, String> redisTemplate) {
    ...
    Map<String, Map<String, Object>> getPaymentSummary(
        ...
        for (String processor : processors) {
            Set<String> entries = fetchPaymentsByTimeFrame(processor, fromMillis, toMillis);
    ...
    private static void extracted(String processor, Set<String> entries, Map<String, Map<String, Object>> summary) {
    ...
    private Set<String> fetchPaymentsByTimeFrame(String processor, long fromMillis, long toMillis) {
